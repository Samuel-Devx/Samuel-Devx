...
```java
public class SamuelDev {

    String  nome        = "Samuel Duarte Alves";
    String  role        = "Java Back-end Developer";
    String  curso       = "Engenharia de Software — Uniasselvi";
    String  localizacao = "Rio de Janeiro, Brasil 🌊";

    String[] backend    = { "Java", "Spring Boot", "Node.js" };
    String[] frontend   = { "Angular", "HTML5", "CSS3", "JavaScript" };
    String[] databases  = { "MySQL", "PostgreSQL", "MongoDB" };
    String[] tools      = { "Maven", "Gradle", "Git", "Docker" };

    String  objetivo    = "Evoluir para Full Stack 🚀";
    boolean apaixonado  = true;
...
- 🖥️ **Desenvolvedor Java Back-end**
- 🎓 **Engenharia de Software — Uniasselvi**
- 📍 **Rio de Janeiro — Brasil 🌊**
- 💻 **Apaixonado por APIs REST, Back-end e boas práticas**
- 🌱 **Focado em Java, Spring Boot e Bancos de Dados**
- 🚀 **Evoluindo para um perfil Full Stack no futuro**
...
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/samuka.deev)
